...
/**
 * Created by Phuc Engineer on 10/13/2018.
 * <p>
 * Add some transition effects to game screen
 */
public abstract class DirectedGame implements ApplicationListener {
    ...
    /**
     * Continuously update & render the game world to the screen here
     */
    @Override
    public void render() {
        /** update game world by the delta time has passed since last rendered frame*/
